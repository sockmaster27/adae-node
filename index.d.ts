 ...
 */
export abstract class ExposedObject {
    /**
...
export abstract class Track extends ExposedObject {
    /**
 ...
 */
export abstract class StoredClip extends ExposedObject {
    /**
 ...
 */
export abstract class Clip extends ExposedObject {
    /**
     * Unique identifier of the clip.
     */
    getKey(): number;
 ...
 */
export function inverseMeterScale(value: number): number;
 ...
 */
export function getDebugOutput(): Promise<string>;
